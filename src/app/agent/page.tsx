...
export const metadata = {
  title: "College Advisors | Ink EduVerse",
  description: "Browse verified college advisors and education administrators",
};
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-400 font-mono mt-0.5 uppercase tracking-wide">
                    {agent.collegeProfile?.organizationName || "Education Advisor"}
                  </p>
                </div>
                <div className="flex items-center gap-1 text-[11px] font-bold text-slate-600 bg-white border border-line px-3 py-1 rounded-full">
                  ...
                  <span>{agent.collegeProfile?.ratingAverage?.toFixed(1) ?? 0} Rating</span>
                </div>
              </Link>
            );
          })}
